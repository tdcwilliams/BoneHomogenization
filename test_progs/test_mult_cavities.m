...
if 0
  ...
  if use_square
    ...
    midi={[m1 1],[m1 1],[m2 1],[m2 1]};
    midi_gf={{m1 1 bc},{m1 1 bc},{m2 1 bc},{m2 1 bc}};
  else
    ...
    midi={[m1 1],[m2 1],[m1 1],[m2 1]};
    midi_gf={{m1 1 bc},{m2 1 bc},{m1 1 bc},{m2 1 bc}};
  end
  for r=1:Nfib
...
if 1
  ...
  C_eff=BONE_GF_cracks_rect_cell(AB,Irr_vars_gf,NtermsTn);
    Mmat_GFcrk=C_eff{1}%, return 
  
  if 1
    C_eff=BONE_GF_cavs_rect_cell(AB,Irr_vars_gf,Nterms);
    Mmat_GF=C_eff{1}
...
%  return;
  ...
  C_eff=BONE_MP_cavs_rect_cell(AB0,Irr_vars0,Nterms0);
  Mmat_MP0=C_eff{1}

  C_eff=BONE_GF_cavs_rect_cell(AB0,Irr_vars_gf0,Nterms0);
  Mmat_GF0=C_eff{1}
  ...
  C_eff=BONE_GF_cracks_rect_cell(AB0,Irr_vars_gf0,NtermsTn);
  Mmat_GFcrk=C_eff{1}
