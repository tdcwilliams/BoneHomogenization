...
if 0
  ...
  if use_square
    ...
    bc={0,0,one_diff,one_diff};
    midi={[5 1],[5 1],[5-3*one_diff 1],[5-3*one_diff 1]};
    midi_gf={{5 1 bc{1}},{5 1 bc{2}},{5-3*one_diff 1 bc{3}},{5-3*one_diff 1 bc{4}}};
  else
    ...
    bc={0,one_diff,0,one_diff};
    midi_gf={{5 1 bc{1}},{5-3*one_diff 1 bc{2}},{5 1 bc{3}},{5-3*one_diff 1 bc{4}}};
  end
  for r=1:Nfib
  ...
  if one_diff 
    ...
    bc={0,one_diff};
    midi_gf={{5 1 bc{1}},{5-3*one_diff 1 bc{2}}};
    Nfib0=2
  else
    %% if all fibres are identical and equally spaced
