function C_eff=BONE_GF_cavs_rect_cell(AB,Irr_vars,Nterms);
%% CALL: C_eff=BONE_GF_cavs_rect_cell(AB,Irr_vars,Nterms);
%%
%% DESCRIPTION:
...
for j=1:Nirregs
  ...
  for r=1:Nirregs
    ...
    GEOM_stuff={Geom_Stuff(j,:),Geom_Stuff(r,:)};
    %%
    theta0=Geom_Stuff{r,5};
    ip_left=-LC*ip_chi;
    ip_right=( LC0*w_qd.*exp(1i*theta0) )';
