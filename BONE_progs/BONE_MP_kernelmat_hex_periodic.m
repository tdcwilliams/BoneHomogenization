function [M_dnW,M_W,xtra]  = BONE_MP_kernelmat_hex_periodic(...
...
BDrho    = MP_stuff{2};
%%
W     = BONE_multipoles_laplace_hexperiodic(...
             xx,yy,M,BDrho,centre);
M_W   = ip_d1chi*[real(W),imag(W)];
%%
[W_x,W_y]   = BONE_diff_multipoles_laplace_hexperiodic(...
             xx,yy,M,BDrho,centre);
